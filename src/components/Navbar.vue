<template>
  <nav class="navbar">
    <div class="nav-links">
      <router-link to="/login" class="nav-item"><strong>AWE Electronics</strong></router-link>
    ...
    <div class="account-cart">
      <router-link v-if="!currentUser" to="/login" class="nav-item">Log In</router-link>
      <router-link v-else to="/accounts" class="nav-item">Account</router-link>
...
export default {
  ...
  watch: {
    // Watch route changes to catch login/logout actions
    $route() {
      this.loadUser();
    }
  }
